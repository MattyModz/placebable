...
function Cardgreen({ role, name }) {
  return (
    <div className="bg-[#8CD87C] p-8 m-4 rounded-xl">
      <p className="p-8">
        {" "}
        &lsquo;They took the time to really understand me as an individual and
        what I was looking for in my next move, this went beyond surface level
        trying to sell me a role and meant we had a great understanding of what
        ...
        recruiter truly has my best interest at heart.&lsquo;
      </p>
