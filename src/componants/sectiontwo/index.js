            ...
            <div className="lg:w-3/4">
              <div className="lg:flex justify-between">
                <div className="px-4">
                  ...
                  <div>
                    <p className="py-4 text-xl">
                      ...
                      from you. This way we’ll not only get the best result,
                ...
                <div className="px-4">
                  ...
                  <div>
                    <p className="py-4 text-xl">
                      Throw mud at the wall and see what sticks? Not a chance.
                      We don’t make concessions when it comes to people’s
                      futures. We hone our data and our process to deliver
